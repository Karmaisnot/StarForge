...
function groupAccess(user) {
  ...
  return {
    ...
    // Teachers only receive their taught cohorts from the API. Organization
...
function GroupsDirectory({ route, onNav, branchId, access }) {
  ...
  return (
    <div className="gp3-page gp3-directory">
      <header className="gp3-page-head">
        <div><span className="gp3-eyebrow">Learning operations</span><h1>Groups</h1><p>{access.teachingScope ? 'Your assigned teaching groups only. Open a group to work with its students, schedule, attendance, assignments, and learning record.' : 'Compare groups within your permitted scope, then open the operating record and connected areas available within your responsibilities.'}</p></div>
